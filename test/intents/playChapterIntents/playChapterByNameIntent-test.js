...
test('PlayChapterByNameIntent called by a non signed-in user', async t => {
  const AnonymousRequest = new Request();
  const event = AnonymousRequest.intent('PlayChapterByNameIntent', { chapterName: 'Faatiha' }).build();
